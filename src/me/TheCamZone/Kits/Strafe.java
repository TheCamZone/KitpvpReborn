...
public class Strafe implements Kit {
	...
	public ItemStack[] tools() {
		...
		sword = Main.plugin.getKitHandler().addEnchantment(sword, Enchantment.DAMAGE_ALL, 2, true);
	...
	public PotionEffect[] effects() {
		PotionEffect speed = new PotionEffect(PotionEffectType.SPEED, 1000000, 2, true, true);
		
		return new PotionEffect[] { speed };
	}
