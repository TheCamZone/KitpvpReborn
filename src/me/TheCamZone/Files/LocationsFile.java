...
public class LocationsFile {
	...
	public static void setup()
	{
		...
		if(!file.exists())
		{
			...
			{
				Bukkit.getServer().getConsoleSender().sendMessage("Could not create locations.yml.");
			}
	...
	public static void save()
	{
		...
		{
			Bukkit.getServer().getConsoleSender().sendMessage(ChatColor.RED + "Could not save locations.yml.");
		}
